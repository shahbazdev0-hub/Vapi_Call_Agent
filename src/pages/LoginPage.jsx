      ...
      >
        <div className="glass-effect rounded-2xl shadow-2xl p-8 border border-white/20">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-navy-600">Sign in to access your dashboard</p>
          </div>
          ...
          {/* <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-navy-500">Don't have an account?</span>
            </div>
          </div> */}
          ...
          {/* <div className="text-center">
            <Link
              to={`/signup${searchParams.get('orderId') ? `?orderId=${searchParams.get('orderId')}` : ''}`}
